...
not import anything from ../../llava15-lora/. It loads the base LLaVA 1.5
...
# (the training pipeline this deploy folder serves; a sibling of deploy/, not
# a parent - see the repo README for why they're split like this).
...
# ---------------------------------------------------------------------------
# These MUST stay identical to training (../../llava15-lora/train_llava15_lora.py).
...
def ensure_base_model_cached(base_id: str) -> str:
    ...
    to ../../llava15-lora/hf_cache, git-ignored in both a dev checkout and a
    ...
    in, or produced by ../../llava15-lora/train_llava15_lora.py on this machine).
    """
        ...
        if merged_model_dir:
            ...
            if not adapter.exists():
                raise FileNotFoundError(
                    ...
                    "../../llava15-lora/runs/ is gitignored - copy the trained adapter there "
