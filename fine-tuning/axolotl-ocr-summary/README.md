...
Fine-tuning small language models with [Axolotl](https://axolotl.ai/) and `uv`,
scaling from a single RTX 3090 (24GB) up to multi-GPU.
...
`.cache/` in this folder (`UV_CACHE_DIR`, `HF_HOME`). Nothing touches your global
